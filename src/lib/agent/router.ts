...
function classifyByKeywords(message: string, hasFile: boolean): AIRequestCategory {
  ...
  if (/\b(payroll|13th month|cutoff summary|payslip)\b/.test(m)) return "payroll_preparation";
